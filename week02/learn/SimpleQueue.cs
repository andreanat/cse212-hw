public class SimpleQueue {
    ...
    private void Enqueue(int value) {
        _queue.Add(value);//corrected this part to append the value to the end of the list
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0];//make sure that the first element is removed and returned
        _queue.RemoveAt(0);
        return value;
    }
}